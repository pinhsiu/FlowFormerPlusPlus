...
_CN.percostformer3.sam_checkpoint = None # 新增加
_CN.percostformer3.freeze_bn = False # 新增加
...
_CN.percostformer3.ft_ver = False # 新增加
_CN.percostformer3.sam_scale = 'H' # 新增加
_CN.percostformer3.weighted_add = False # 新增加
# pretrain config
